(function() {
  ...
  .controller('grumblesController', function() {
    ...
    this.comments = [{ "commentAuthor": "author", "commentContent": "content", "grumbleId": 667}]
    this.editComment = function(index){
        console.log("editComment")
        var comment = this.comments[index]
        this.commentAuthor = commentAuthor.commentAuthor
        this.commentContent = commentContent.commentContent
    }
    this.updateComment = function(index){
        console.log("updateComment")
        var comment = this.comments[index]
        comment.commentAuthor = this.commentAuthor
