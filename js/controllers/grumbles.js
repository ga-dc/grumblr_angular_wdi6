(function() {
  ...
  app.controller('grumblesController', function() {
    ...
    this.reset = function(){
      ...
      this.content = "";
      this.photoUrl = "";
      this.comments = [{commentAuthor:"", commentBody:""}];
    }
  ...
  app.controller ('commentsController', function(){
    this.create = function(grumble){
      grumble.comments.unshift({
        commentAuthor: grumble.newCommentAuthor,
        commentBody: grumble.newCommentBody
      });
      grumble.newCommentAuthor = "";
      grumble.newCommentBody = "";
    }
  })
})();
