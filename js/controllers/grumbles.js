(function() {
  ...
  .controller('grumblesController', function() {
    ...
    this.reset = function(){
      ...
      this.content = "";
      this.photoUrl = "";
      this.comment= [{commentAuthor:"", commentBody:""}];
    }
